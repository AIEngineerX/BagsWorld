...
export class BootScene extends Phaser.Scene {
  ...
  // ============================================================
  // BAGSDUNGEON ZONE ASSETS
  // Dark cave dungeon entrance with atmospheric decorations
  // ============================================================

  private generateDungeonAssets(): void {
    this.generateDungeonGround();
    this.generateDungeonEntrance();
    this.generateDungeonTorch();
    this.generateDungeonSkull();
    this.generateDungeonPillar();
    this.generateDungeonBanner();
    this.generateDungeonGate();
    this.generateDungeonTunnel();
  }
  ...
  private generateDungeonGround(): void {
  ...
  private generateDungeonSkull(): void {
    const r = this.r.bind(this);
    const size = r(10);
    const g = this.make.graphics({ x: 0, y: 0 });
