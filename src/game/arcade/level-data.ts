  ...
  switch (section) {
    ...
    case 0:
      return {
        platforms: [],
        enemies: [
          { x: base + 250, y: GROUND_Y - 40, type: "soldier", facing: "left", patrolRange: 60 },
          { x: base + 450, y: GROUND_Y - 40, type: "soldier", facing: "left", patrolRange: 80 },
          { x: base + 680, y: GROUND_Y - 40, type: "soldier", facing: "left", patrolRange: 70 },
        ],
        pickups: [
    ...
    case 1:
      return {
        ...
        enemies: [
          { x: base + 130, y: 180 - 30, type: "turret", facing: "left" },
          { x: base + 560, y: 180 - 30, type: "turret", facing: "left" },
          { x: base + 200, y: GROUND_Y - 40, type: "soldier", facing: "left", patrolRange: 100 },
          { x: base + 400, y: GROUND_Y - 40, type: "soldier", facing: "left", patrolRange: 80 },
          { x: base + 550, y: GROUND_Y - 40, type: "soldier", facing: "right", patrolRange: 90 },
          { x: base + 720, y: GROUND_Y - 40, type: "soldier", facing: "left", patrolRange: 60 },
        ],
        pickups: [
    ...
    case 2:
      return {
        ...
        enemies: [
          { x: base + 180, y: GROUND_Y - 40, type: "heavy", facing: "left", patrolRange: 80 },
          { x: base + 550, y: GROUND_Y - 40, type: "heavy", facing: "left", patrolRange: 100 },
          { x: base + 250, y: GROUND_Y - 40, type: "soldier", facing: "left", patrolRange: 60 },
          { x: base + 420, y: 170 - 40, type: "soldier", facing: "right", patrolRange: 40 },
          { x: base + 650, y: GROUND_Y - 40, type: "soldier", facing: "left", patrolRange: 80 },
          { x: base + 750, y: GROUND_Y - 40, type: "soldier", facing: "left", patrolRange: 50 },
        ],
        pickups: [
    ...
    case 3:
      return {
        ...
        enemies: [
          { x: base + 280, y: 170 - 30, type: "turret", facing: "left" },
          { x: base + 450, y: 155 - 40, type: "soldier", facing: "left", patrolRange: 40 },
          { x: base + 620, y: 165 - 40, type: "soldier", facing: "right", patrolRange: 50 },
          { x: base + 150, y: GROUND_Y - 40, type: "soldier", facing: "left", patrolRange: 80 },
          { x: base + 500, y: GROUND_Y - 40, type: "soldier", facing: "left", patrolRange: 100 },
          { x: base + 730, y: 190 - 30, type: "turret", facing: "left" },
        ],
        pickups: [
    ...
    case 4:
      return {
        ...
        enemies: [
          { x: base + 100, y: GROUND_Y - 40, type: "heavy", facing: "left", patrolRange: 80 },
          { x: base + 350, y: GROUND_Y - 40, type: "heavy", facing: "left", patrolRange: 100 },
          { x: base + 650, y: GROUND_Y - 40, type: "heavy", facing: "left", patrolRange: 60 },
          { x: base + 150, y: GROUND_Y - 40, type: "soldier", facing: "left", patrolRange: 70 },
          { x: base + 280, y: GROUND_Y - 40, type: "soldier", facing: "right", patrolRange: 60 },
          { x: base + 450, y: GROUND_Y - 40, type: "soldier", facing: "left", patrolRange: 90 },
          { x: base + 550, y: GROUND_Y - 40, type: "soldier", facing: "left", patrolRange: 50 },
          { x: base + 700, y: GROUND_Y - 40, type: "soldier", facing: "right", patrolRange: 80 },
          { x: base + 750, y: GROUND_Y - 40, type: "soldier", facing: "left", patrolRange: 60 },
          { x: base + 160, y: 185 - 30, type: "turret", facing: "left" },
          { x: base + 620, y: 190 - 30, type: "turret", facing: "left" },
        ],
        pickups: [
    ...
    case 5:
      return {
        platforms: [],
        enemies: [{ x: base + 600, y: GROUND_Y - 80, type: "boss", facing: "left" }],
        pickups: [
