...
export const docsContent: DocSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: "creator-rewards",
        title: "BagsApp Marketplace & Agent Economy",
        content: [
          "BagsWorld charges zero extra fees on token launches. Creators keep 100% of their configured fee share.",
          "$BagsWorld token fees route to BagsApp Marketplace apps for automated growth: 30% DividendsBot (auto-pays top 100 holders daily), 30% DEX Boosts (auto-buys DexScreener visibility), 20% Compound Liquidity (deepens pool), 20% BagsAMM (volume support).",
        ],
        table: {
          headers: ["App", "Share", "Function"],
          rows: [
        ...
        infoBox: {
          ...
          items: [
            ...
            "BagsApp Marketplace handles automated token growth",
