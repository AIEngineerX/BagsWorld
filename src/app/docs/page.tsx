      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="mb-8 bg-gradient-to-r from-bags-green/10 to-bags-gold/10 border-2 border-bags-green p-4">
            <h1 className="font-pixel text-sm text-bags-green mb-2">
              BAGSWORLD DOCUMENTATION
            </h1>
            <p className="font-pixel text-[9px] text-gray-300 leading-relaxed">
              Welcome to BagsWorld! This guide covers everything you need to
              know about launching tokens, understanding the world mechanics,
              and integrating with Bags.fm. Use the sidebar to navigate between
              sections.
            </p>
          </div>
