        ...
        {activeTab === "fees" && (
          <div className="p-4 space-y-4">
            ...
            {!feeLoading && !feeError && feeData && (
              <>
                {/* Stats — compact grid, no giant hero numbers */}
                <div className="grid grid-cols-3 gap-3">
                  <div className="bg-black/30 rounded-lg p-3 border border-gray-700 text-center">
                    <div className="font-pixel text-[7px] text-gray-400 mb-1">Lifetime Fees</div>
                    <div className="font-pixel text-sm text-bags-green">
                      <AnimatedNumber value={feeData.tokenLifetimeFeesSol} />
                    </div>
                    <div className="font-pixel text-[7px] text-gray-500">SOL</div>
                  </div>
                  <div className="bg-black/30 rounded-lg p-3 border border-gray-700 text-center">
                    <div className="font-pixel text-[7px] text-gray-400 mb-1">Total Claimed</div>
                    <div className="font-pixel text-sm text-bags-green">
                  ...
                  <div className="bg-black/30 rounded-lg p-3 border border-gray-700 text-center">
                    <div className="font-pixel text-[7px] text-gray-400 mb-1">Claims</div>
                    <div className="font-pixel text-sm text-bags-gold">{feeData.claimCount}</div>
                    <div className="font-pixel text-[7px] text-gray-500">transactions</div>
                  </div>
                </div>

                {feeData.tokenLifetimeFeesSol === 0 && feeData.claimCount === 0 && (
                  <div className="bg-bags-darker rounded-lg p-4 border border-gray-700 text-center">
                    ...
                    <p className="font-pixel text-gray-400 text-[9px]">
                      No fee activity yet for $BagsWorld. Fees accumulate as people trade the token.
                    </p>
                  </div>
                )}

                {/* Fee Distribution — always show to explain the model */}
