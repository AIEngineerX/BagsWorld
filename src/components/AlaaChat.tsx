...
export function AlaaChat() {
  ...
  return (
    <div
      ref={chatRef}
      style={chatStyle}
      className={`fixed z-50 w-[calc(100vw-2rem)] sm:w-80 max-w-80 bg-bags-dark border-4 border-indigo-500 shadow-lg shadow-indigo-500/20 ${isDragging ? "cursor-grabbing" : ""}`}
    >
      <div
