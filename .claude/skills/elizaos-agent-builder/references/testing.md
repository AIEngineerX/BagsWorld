...
describe("Help Action Handler", () => {
  it("should return helpful response", async () => {
    ...
    const result = await helpAction.handler(mockRuntime, message, mockState, {}, (response) => {
...
describe("Action with Provider Context", () => {
  it("should use provider data in action", async () => {
    ...
    const result = await tradeAction.handler(mockRuntime, message, stateWithProvider, {}, () => {});
