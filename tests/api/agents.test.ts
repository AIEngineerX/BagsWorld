...
describe('Agents API Route', () => {
  ...
  describe('Fallback Responses', () => {
    ...
    it('neo responses should be cryptic/scanning themed', () => {
      ...
      const hasScanning = neoResponses.some(r => r.includes('scanning') || r.includes('watching'));
    ...
    it('ghost responses should be rewards/fee themed', () => {
      ...
      const hasRewards = ghostResponses.some(r => r.includes('Rewards') || r.includes('50/30/20'));
