      ...
      const turns: DialogueTurn[] = [
        {
          speaker: "neo",
          speakerName: "Neo",
          message: "this looks great, bullish signals",
          timestamp: Date.now(),
        },
        {
          speaker: "cj",
          speakerName: "CJ",
          message: "wagmi fam, this is amazing",
          timestamp: Date.now(),
        },
      ];
      ...
      const turns: DialogueTurn[] = [
        {
          speaker: "neo",
          speakerName: "Neo",
          message: "this looks bad, bearish patterns",
          timestamp: Date.now(),
        },
        {
          speaker: "cj",
          speakerName: "CJ",
          message: "ngmi, terrible setup",
          timestamp: Date.now(),
        },
      ];
      ...
      const turns: DialogueTurn[] = [
        {
          speaker: "neo",
          speakerName: "Neo",
          message: "great excellent amazing",
          timestamp: Date.now(),
        },
      ...
      it("should return dialogue structure", async () => {
        const mockResponse = {
          ...
          dialogue: {
            ...
            initiator: "neo",
            turns: [{ speaker: "neo", speakerName: "Neo", message: "test", timestamp: Date.now() }],
            sentiment: "neutral",
